...
sealed class Either<L, R> {
  ...
  L get error =>
      this.fold<L>((value) => value, (right) => throw Exception('Illegal use. You should check isFailure before calling'));

  /// Get [Right] value, may throw an exception when the value is [Left]
  R get success =>
      this.fold<R>((left) => throw Exception('Illegal use. You should check isSuccess before calling'), (value) => value);
